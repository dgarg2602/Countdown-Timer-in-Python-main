...
class CountDown:
    def __init__(self, root):
        ...
        self.window.configure(bg='aquamarine')
        ...
        # inside this frame
        self.button_frame = Frame(self.window, bg="aquamarine", \
        width=240, height=40)
        self.button_frame.place(x=230, y=150)
        # This frame is used to show the countdown time label
        self.time_frame = Frame(self.window, bg="aquamarine", \
        width=480, height=120).place(x=0, y=210)

        # Tkinter Labels
        time_label = Label(self.window, text="Countdown Timer in Python - Set an Appropriate Time", 
        font=("times new roman",12, "bold"), bg='gray35',fg='yellow')
